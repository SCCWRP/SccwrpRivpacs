# This test verifies the ability to process user files containing every possible taxon.

# Also tests the ability to handle lower case habitat codes.
...
ts <- "TestAllSpecies"
uf <- "R CMD check Test All Possible Species"
